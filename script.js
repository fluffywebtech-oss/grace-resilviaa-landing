(function () {
  ...
  document.querySelectorAll('.g-item, .am-card, .plan-img, .loc-map').forEach(function (fig) {
    fig.addEventListener('click', function () {
      var img = fig.querySelector('img'); if (!img) return;
      var cap = fig.getAttribute('data-caption') ||
        (fig.querySelector('figcaption') && fig.querySelector('figcaption').textContent) || img.alt;
  ...
  form.addEventListener('submit', function (e) {
    ...
    var waText = encodeURIComponent("Hi, I'm " + fullName + ". I'm interested in Grace Resilviaa" + cfg + ". Please share the details.");
